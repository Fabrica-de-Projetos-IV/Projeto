                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        <div class="features-title-icon d-flex justify-content-between">
                            <h4 class="features-title"><a>Front-end</a></h4>
                        ...
                        <div class="features-content">
                            <p class="text">O desenvolvedor front-end é responsável pelo desenvolvimento da interface com o usuário. Trata-se da parte visível de um site ou aplicação, 
                                com a qual as pessoas podem interagir, visando a usuabiliadade e design. </p>
                        </div>
                    </div> <!-- single features -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        <div class="features-title-icon d-flex justify-content-between">
                            <h4 class="features-title"><a>Back-end</a></h4>
                            <div class="features-icon">
                        ...
                        <div class="features-content">
                            <p class="text">O desenvolvedor back-end é responsável pelo desenvolvimento da estrutura interna de uma aplicação. É a parte que recebe as requisições dos usuários, 
                                faz a comunicação com o banco de dados e devolve as informações. </p>
                        </div>
                    </div> <!-- single features -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        <div class="features-title-icon d-flex justify-content-between">
                            <h4 class="features-title"><a>Full-stack</a></h4>
                            <div class="features-icon">
                        ...
                        <div class="features-content">
                            <p class="text">O desenvolvedor full-stack é aquele que trabalha tanto com o front-end quanto com o back-end. Portanto, 
                                envolve o fluxo completo da aplicação, desde a conexão com o banco de dados até a criação da interface gráfica.</p>
                        </div>
                    </div> <!-- single features -->
                </div>
            </div> <!-- row -->
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="portfolio-menu text-center mt-50">
                        <ul>
                            ...
                            <li data-filter=".branding-4">Front-end</li>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="assets/images/devdojo.jpg" alt="">
                        </div>
                        <div class="pricing-header text-center">
                            <h5 class="sub-title">Dev Dojo</h5>
                            <p class="month"><span class="price">Gratuito</span></p>
                        </div>
                        <div class="pricing-list">
                            <ul>
                                <li><i class="lni lni-check-mark-circle"></i> Essa trilha irá te ajudar</li>
                                <li><i class="lni lni-check-mark-circle"></i> no inicio da sua carreira como dev</li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="assets/images/loiane.jpg" alt="">
                        </div>
                        <div class="pricing-header text-center">
                            <h5 class="sub-title">Loiane Groner</h5>
                            <p class="month"><span class="price">Gratuito</span></p>
                        </div>
                        <div class="pricing-list">
                            <ul>
                                <li><i class="lni lni-check-mark-circle"></i> Essa trilha irá te ajudar</li>
                                <li><i class="lni lni-check-mark-circle"></i> com as principais estruturas básicas</li>
                            </ul>
                        </div>
                        <div class="pricing-btn rounded-buttons text-center">
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="assets/images/guarana.jpg" alt="">
                        </div>
                        <div class="pricing-header text-center">
                        ...
                        <div class="pricing-list">
                            <ul>
                                <li><i class="lni lni-check-mark-circle"></i> Essa trilha irá te ajudar</li>
                                <li><i class="lni lni-check-mark-circle"></i> como se tornar Full-stack</li>
                            </ul>
                        </div>
                        <div class="pricing-btn rounded-buttons text-center">
